...
class BamlSyncClient:
    ...
    def Roll(self, request: str,context: typing.Optional[str] = None,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="Roll", args={
...
class BamlStreamClient:
    ...
    def Roll(self, request: str,context: typing.Optional[str] = None,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="Roll", args={
            "request": request,"context": context,
        })
        return baml_py.BamlSyncStream[stream_types.RollPlan, types.RollPlan](
          __result__,
